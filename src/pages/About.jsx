      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="mb-16">
          <div className="text-center mb-10">
            <h2 className="text-2xl font-semibold text-gray-800 mb-3">合作与生态</h2>
            <p className="text-gray-600">携手共建AI创新生态，欢迎企业、高校和机构加入</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* 企业通道 */}
            <div className="bg-white rounded-2xl shadow-sm p-6 hover:shadow-lg transition-all duration-300 group">
              <div className="w-12 h-12 bg-gradient-to-br from-violet-100 to-purple-50 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                <svg className="w-6 h-6 text-[#7463EC]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                </svg>
              </div>
              <h3 className="text-lg font-semibold text-gray-800 mb-2">企业数字化转型通道</h3>
              <p className="text-gray-600 text-sm mb-4 leading-relaxed">
                企业可通过人工智能应用方案参与大赛评审与认证，获得技术创新支持和商业合作机会
              </p>
              <a
                href="/enterprise"
                className="inline-flex items-center gap-2 bg-violet-50 text-[#7463EC] px-4 py-2 rounded-lg font-medium hover:bg-violet-100 transition-colors text-sm"
              >
                申请企业通道
            ...
            {/* 办赛申请 */}
            <div className="bg-white rounded-2xl shadow-sm p-6 hover:shadow-lg transition-all duration-300 group">
              <div className="w-12 h-12 bg-gradient-to-br from-orange-100 to-amber-50 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                <svg className="w-6 h-6 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
              </div>
              <h3 className="text-lg font-semibold text-gray-800 mb-2">联合举办赛事</h3>
              <p className="text-gray-600 text-sm mb-4 leading-relaxed">
                高校、园区、机构可申请成为分赛区或合作单位，共同推动AI创新人才培养
              </p>
              <a
                href="/apply-competition"
                className="inline-flex items-center gap-2 bg-orange-50 text-orange-600 px-4 py-2 rounded-lg font-medium hover:bg-orange-100 transition-colors text-sm"
              >
                申请办赛
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
