        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            <div className="bg-white rounded-2xl shadow-sm p-6 border border-neutral-100">
              ...
              <h3 className="text-lg font-semibold text-neutral-800 mb-2">算力支持</h3>
              <p className="text-neutral-600">提供GPU算力资源与训练环境支持</p>
            </div>
            <div className="bg-white rounded-2xl shadow-sm p-6 border border-neutral-100">
              <div className="w-14 h-14 bg-primary/10 rounded-xl flex items-center justify-center mb-4">
                <svg className="w-7 h-7 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-lg font-semibold text-neutral-800 mb-2">导师指导</h3>
              <p className="text-neutral-600">行业专家与技术导师全程辅导</p>
            </div>
            <div className="bg-white rounded-2xl shadow-sm p-6 border border-neutral-100">
              <div className="w-14 h-14 bg-primary/10 rounded-xl flex items-center justify-center mb-4">
                <svg className="w-7 h-7 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-lg font-semibold text-neutral-800 mb-2">数据与工具</h3>
              <p className="text-neutral-600">开放数据集与开发工具支持</p>
            </div>
            <div className="bg-white rounded-2xl shadow-sm p-6 border border-neutral-100">
              <div className="w-14 h-14 bg-primary/10 rounded-xl flex items-center justify-center mb-4">
                <svg className="w-7 h-7 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-lg font-semibold text-neutral-800 mb-2">孵化与对接</h3>
              <p className="text-neutral-600">优秀项目可获得产业资源与落地机会</p>
            </div>
            <div className="bg-white rounded-2xl shadow-sm p-6 border border-neutral-100">
              <div className="w-14 h-14 bg-primary/10 rounded-xl flex items-center justify-center mb-4">
                <svg className="w-7 h-7 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-lg font-semibold text-neutral-800 mb-2">奖励与激励</h3>
              <p className="text-neutral-600">奖金、证书与荣誉体系</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl shadow-sm p-8 border border-neutral-100 hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-neutral-800 mb-4">高性能算力资源</h3>
              <p className="text-neutral-600">
            ...
            <div className="bg-white rounded-2xl shadow-sm p-8 border border-neutral-100 hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-neutral-800 mb-4">真实产业应用场景</h3>
              <p className="text-neutral-600">
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-gradient-to-r from-primary to-indigo-600 rounded-2xl p-12 text-center">
            ...
            <Link to="/competition-center">
              <PrimaryButton className="text-lg px-8 py-4 bg-white text-primary hover:bg-neutral-100">
                立即报名
              </PrimaryButton>
            </Link>
          </div>
