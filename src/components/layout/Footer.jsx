    ...
    <footer className="bg-neutral-800 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">梧桐·鸿鹄</h3>
            <p className="text-neutral-400 text-sm">
              人工智能应用创新大赛官方网站，致力于推动AI技术在各行业的应用落地。
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-neutral-400">
              ...
              <li><Link to="/about" className="hover:text-white transition-colors">关于大赛</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-neutral-400">
              ...
              <li>邮箱：contact@honghu-competition.com</li>
        ...
        <div className="border-t border-neutral-700 mt-8 pt-8 text-center text-sm text-neutral-400">
          <p>© 2024 梧桐·鸿鹄人工智能应用创新大赛. 保留所有权利.</p>
        </div>
      </div>
    </footer>
  );
