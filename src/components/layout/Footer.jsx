...
const Footer = () => {
  return (
    <footer className="bg-[#0a0a0f] text-white py-8 lg:py-16">
      <div className="container mx-auto px-3 md:px-4 max-w-7xl">
        ...
        <div className="hidden lg:block">
          <div className="grid grid-cols-4 gap-8">
            {/* 主办单位 */}
            <div>
              <h3 className="text-xl font-bold mb-4">主办单位</h3>
              <div className="space-y-4">
                <div className="flex flex-col items-center">
                  <div className="w-24 h-24 rounded-xl bg-white/8 backdrop-blur-sm border border-white/15 flex items-center justify-center mb-2 p-2">
                ...
                <div className="flex flex-col items-center">
                  <div className="w-24 h-24 rounded-xl bg-white/8 backdrop-blur-sm border border-white/15 flex items-center justify-center mb-2 p-2">
                    <span className="text-xs text-white/40">中科北龙</span>
                  </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                <Link to="/reviewer-login" className="flex items-center gap-2 h-14 bg-white/[0.06] backdrop-blur-sm border border-white/[0.08] rounded-xl px-4 hover:bg-white/[0.1] transition-all duration-200">
                  <div className="w-8 h-8 rounded bg-gradient-to-br from-violet-500/20 to-purple-500/20 flex items-center justify-center">
                    <svg className="w-4 h-4 text-violet-400" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>
                  </div>
                  <span className="text-sm text-white/70">专家评审</span>
                </Link>
                <Link to="/admin/login" className="flex items-center gap-2 h-14 bg-white/[0.06] backdrop-blur-sm border border-white/[0.08] rounded-xl px-4 hover:bg-white/[0.1] transition-all duration-200">
                  ...
                  <span className="text-sm text-white/70">管理后台</span>
                </Link>
              </div>
            </div>
          </div>
        ...
        <div className="lg:hidden">
          ...
          <div className="mb-5 md:mb-6">
            ...
            <div className="flex gap-2">
              <Link to="/reviewer-login" className="group flex items-center gap-1.5 md:gap-2.5 flex-1 md:flex-none h-9 md:h-14 bg-white/[0.06] backdrop-blur-sm border border-white/[0.08] rounded-lg md:rounded-xl px-2.5 md:px-4 hover:bg-white/[0.1] hover:-translate-y-px transition-all duration-200 cursor-pointer">
              ...
              <Link to="/admin/login" className="group flex items-center gap-1.5 md:gap-2.5 flex-1 md:flex-none h-9 md:h-14 bg-white/[0.06] backdrop-blur-sm border border-white/[0.08] rounded-lg md:rounded-xl px-2.5 md:px-4 hover:bg-white/[0.1] hover:-translate-y-px transition-all duration-200 cursor-pointer">
                <div className="relative flex-shrink-0">
